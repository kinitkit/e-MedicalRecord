    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_chemistry:
                setActivity(com.e_medicalRecord.kinit.e_medicalrecord.General.Enum.Laboratory_Tests.BLOOD_CHEMISTRY.ordinal());
                break;
            case R.id.tv_fecalysis:
                setActivity(com.e_medicalRecord.kinit.e_medicalrecord.General.Enum.Laboratory_Tests.FECALYSIS.ordinal());
                break;
            case R.id.tv_hematology:
                setActivity(com.e_medicalRecord.kinit.e_medicalrecord.General.Enum.Laboratory_Tests.HEMATOLOGY.ordinal());
                break;
            case R.id.tv_urinalysis:
                setActivity(com.e_medicalRecord.kinit.e_medicalrecord.General.Enum.Laboratory_Tests.URINALYSIS.ordinal());
                break;
        }
    }
