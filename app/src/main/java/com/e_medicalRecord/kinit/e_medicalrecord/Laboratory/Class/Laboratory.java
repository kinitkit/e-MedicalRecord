...
public class Laboratory implements Parcelable {
    ...
    public String physician_name, pathologist, medTech, lab_name, strDatePerformed, remarks;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.pathologist);
        dest.writeString(this.medTech);
    ...
    protected Laboratory(Parcel in) {
        ...
        this.pathologist = in.readString();
        this.medTech = in.readString();
