...
public class Bus_Open_Add_Drug {
    ...
    public Bus_Open_Add_Drug(String drug, String strength, String amount, String route, String frequency, String why, String many, String refill, Query_Type queryType, int position) {
        this.drug = drug;
