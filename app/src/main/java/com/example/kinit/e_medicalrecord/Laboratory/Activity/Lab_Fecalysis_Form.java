...
import com.example.kinit.e_medicalrecord.Laboratory.Class.Lab_Fecalysis;
...
public class Lab_Fecalysis_Form extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    void setToEditText() {
        ...
        editTexts.get(1).setText(labFecalysis.lab_name);
        setCalendar(labFecalysis.datePerformed);
        editTexts.get(3).setText(labFecalysis.color);
        editTexts.get(4).setText(labFecalysis.consistency);
        editTexts.get(5).setText(labFecalysis.ascarisLumbricoides);
        editTexts.get(6).setText(labFecalysis.trichurisTrichiura);
        editTexts.get(7).setText(labFecalysis.enterobiusVermicularis);
        editTexts.get(8).setText(labFecalysis.hookwormOva);
        editTexts.get(9).setText(labFecalysis.giardiaLambia);
        editTexts.get(10).setText(labFecalysis.blastocystisHominis);
        editTexts.get(11).setText(labFecalysis.cyst);
        editTexts.get(12).setText(labFecalysis.trophozoite);
        editTexts.get(13).setText(labFecalysis.occultBlood);
        editTexts.get(14).setText(labFecalysis.pusCells);
        editTexts.get(15).setText(labFecalysis.rbc);
        editTexts.get(16).setText(labFecalysis.fatGlobules);
        editTexts.get(17).setText(labFecalysis.yeastCells);
        editTexts.get(18).setText(labFecalysis.undigestedFood);
        editTexts.get(19).setText(labFecalysis.starchGranules);
        editTexts.get(20).setText(labFecalysis.remarks);
    }
